...
<body>
    ...
    <nav class="nav-material grey lighten-5">
      <div class="nav-wrapper">
        <a style="padding-left: 20px;padding-top: 3px" href="#!" class="hide-lg brand-logo">
          <img class="img-brand" src="<?= base_url() . "assets/" ?>images/logo2.png">
        </a>
        ...
        <ul class="side-nav fixed grey lighten-4" id="mobile-demo">
          <div class="side-logo hide-sm ">
            <img src="<?= base_url() . "assets/" ?>images/logo2.png" style="height: 70px; width: 90px; padding-bottom: 5px; ">
          </div>
          <li>
            <div class="user-view">
          ...
          <li><a href="<?= site_url('admin/place') ?>"><i class="material-icons">location_on</i> Stasiun</a></li>
  ...
  <footer class="page-footer">
    <div class="footer-copyright blue">
      <div class="container">
        <span>Copyright &copy; 2020 <a class="grey-text text-lighten-4" href="<?= base_url() ?>" target="_blank">K A B</a> All rights reserved.</span>
